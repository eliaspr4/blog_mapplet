...
<div class="form-group">
    ...
    <textarea class="form-control" rows="5" id="contenido" name="texto" placeholder="Escribe tu artículo aquí."></textarea>
</div>
<div class="checkbox">
    <label>
        <input type="checkbox" name="publicar" value="si">Marca este cuadro si quieres que la entrada se publique de inmediato
    </label>
</div>
<br>
