...
<nav class="navbar navbar-default navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo SERVIDOR ?>">mapplet</a>
        </div>
        <div id=navbar class="navbar-collapse collapse">
           ...
           <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo RUTA_FAVORITOS ?>"><i class="fa fa-heart" aria-hidden="true"></i> Favoritos</a></li>
                <li><a href="<?php echo RUTA_AUTORES ?>"><i class="fa fa-users" aria-hidden="true"></i> Autores</a></li>
            </ul>
            <?php
            }
            ?>
