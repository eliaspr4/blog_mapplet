...
<div class="form-group">
    ...
    <textarea class="form-control" rows="5" id="contenido" name="texto" placeholder="Escribe tu artículo aquí."
         ><?php $validador->mostrar_texto(); ?></textarea>
    <?php $validador -> mostrar_error_texto(); ?>
</div>
<div class="checkbox">
    <label>
        <input type="checkbox" name="publicar" value="si" <?php if($entrada_publica)echo 'cheked'; ?>
               >Marca este cuadro si quieres que la entrada se publique de inmediato
    </label>
</div>
<br>
